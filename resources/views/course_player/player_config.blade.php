...
if (typeof player === 'object' && player !== null) {
    player.addEventListener('ended', () => {
        ...
        let next_lesson_id = '{{ next_lesson($course_details['id'], $lesson_details['id']) }}';

        // Send POST request to set.watch.history
        fetch('{{ route("set.watch.history") }}', {
            method: 'POST',
            headers: {
        ...
        // Start countdown if there's a next lesson
        if (next_lesson_id) {
