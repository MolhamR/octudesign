...
<Style>
    ...
    .testimonials-wrapper .container .align-items-center{
        direction: rtl;
    }
    ...
    ul .dropdown-menu , .dropmenu-end , .show{
        direction: ltr;
    }
    .accordion-collapse .accordion-body .answer{
            direction: rtl;
    }
...
<body dir="rlt" style="direction: rtl; ">
